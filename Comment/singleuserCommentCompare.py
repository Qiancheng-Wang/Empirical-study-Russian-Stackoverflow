...
try :
    with connection.cursor() as cursor :
        ...
        flag = 1
        sql1 = 'select CreationDate from Russiancomment where userid = 11304  ;'
        cursor.execute(sql1)
        result1 = cursor.fetchall()

        sql2 = 'select creationdate from russianuserinfo where Id = 11304  ;'
        cursor.execute(sql2)
        ...
        flag = 1
        sql1 = 'select CreationDate from stackcorecomment where userid = 815386 ;'
        cursor.execute(sql1)
        result1 = cursor.fetchall()

        sql2 = 'select creationdate from coreuser where Id = 11304  ;'
        cursor.execute(sql2)
        result3 = cursor.fetchone()
        print(result3)
        usercreationdate = str(result3['creationdate'])[0:10] + ' ' + str(result3['creationdate'])[11:19]
        ...
        py.plot(fig, filename='TotalInactive comment')
