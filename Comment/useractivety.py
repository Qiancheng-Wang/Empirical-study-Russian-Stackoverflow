...
try :
    with connection.cursor() as cursor :
        ...
        while flag1 < len(result1):
            ...
            elif afterMigrationRussianPost >= 0.9 * comparenumber_post and afterMigrationRussianPost < 1.1 * comparenumber_post:
            ...
            if afterMigrationStackpost >=  1.1* comparenumber_post :
            ...
            elif afterMigrationStackpost >= 0.9 * comparenumber_post and afterMigrationStackpost <  1.1* comparenumber_post:
                stack_post_equal += 1
                ...
                ####################################
                ####################################
            if afterMigrationRussianPost >= 1.1 * comparenumber_post and afterMigrationStackpost >=  1.1* comparenumber_post:
                    # print(afterCreatedRussianAccount_Russian_Answer + afterCreatedRussianAccount_Russian_Question)
                both_active += 1

            elif afterMigrationRussianPost >= 0.9 * comparenumber_post and afterMigrationStackpost >=  0.9* comparenumber_post \
                    and afterMigrationRussianPost < 1.1 * comparenumber_post and afterMigrationStackpost <  1.1* comparenumber_post:
                both_equal += 1
            else:
                bothe_inactive += 1
            ...
            elif (afterMigrationRussianPost + afterMigrationStackpost ) >= 0.9 * comparenumber_post and (afterMigrationRussianPost + afterMigrationStackpost ) <  1.1* comparenumber_post:
                total_post_equal += 1
            ...
            if flag3 == 2 and afterMigrationRussianPost > 300:
                print(thisaccoutid, afterMigrationRussianPost)
