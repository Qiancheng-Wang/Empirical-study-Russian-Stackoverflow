...
try :
    with connection.cursor() as cursor :
        ...
        flag = 1
        sql1 = 'select CreationDate from Russiancorepost where owneruserid = 10105 ;'
        cursor.execute(sql1)
        result1 = cursor.fetchall()

        sql2 = 'select creationdate from coreuser where Id = 10105  ;'
        cursor.execute(sql2)
        ...
        flag = 1
        sql1 = 'select CreationDate from stackcorepost where owneruserid = 276994 ;'
        cursor.execute(sql1)
        result1 = cursor.fetchall()
