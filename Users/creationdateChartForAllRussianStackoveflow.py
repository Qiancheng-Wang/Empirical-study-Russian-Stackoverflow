...
try :
    with connection.cursor() as cursor :
        ...
        while 1:
            ...
            sql = 'select CreationDate from NewRussianUserInfo where rownum = %s ;' % flag
            cursor.execute(sql)
        ...
        file = open('C:\\Users\\Administrator\\Desktop\\result_CreateMonth.txt', 'a')
        file.write("From 2010  -----2017 . march .28\n\n\n\n\n\n")
        str = str(month2010_count)
        file.write(str)
        str = str(month2011_count)
        file.write(str)
        str = str(month2012_count)
        file.write(str)
        str = str(month2013_count)
        file.write(str)
        str = str(month2014_count)
        file.write(str)
        str = str(month2015_count)
        file.write(str)
        str = str(month2016_count)
        file.write(str)
        str = str(month2017_count)
        file.write(str)
        file.close()
