...
For these 3247 overlap core Russian Stackoverflow users , they have 181,643 posts,which includes 59312 questions and 122331 answers. And for those 1402 overlap core Russian Stackoverflow users who from stackoverflow site, they have 77466 posts, which includes 17353 questions and 60113 answers. Compare the average number is , 1:2.062 vs 1:3.464.

The comment amount distribution chart is in figure 12. We can see that the majority of the russian users haven't post any comment. 
\begin{figure}[H]
		\includegraphics[width = 0.42\textwidth]{comment.png}
		\caption{comments amount distribution}
  	\end{figure}
