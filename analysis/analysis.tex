...
\end{tabular}
\end{table}
\\For the 6,489 core users who already have Stackoverflow account before thier creation of Russian Stackoverflow account, the compare between the post activities before their migration with the post activities after their migration can definitly reveal their emphasized aspect.
The idea is that the object of reference of the users it themselve. Calculate the average post/quesiton/answer numbers during their time when they only use stackoverflow account and after their creation of Russian Stackoverflow account, then compare these two numbers to decide whether a single user is still active or already swithed their avtivity site.
the results are represented in the figure 11.
