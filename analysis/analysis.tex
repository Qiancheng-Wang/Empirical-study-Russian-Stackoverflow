...
some results in figure 15
 \begin{figure}[H]
	...
	\includegraphics[width=0.8\columnwidth]{commentcompare1.png} 
	}
	\subfigure[Comments compare between migration core users with the other coreusers ] { \label{fig:b} 
	\includegraphics[width=0.8\columnwidth]{commentcompare2.png} 
	}  
...
Also, calculating the comment ratio similarly with post ratio. And there are two figure in high similarity.
 \begin{figure}[H]
 		\centering 
	\subfigure[Commentsratio] { \label{fig:b} 
	\includegraphics[width=0.8\columnwidth]{commentratio1.png} 
	}
	\subfigure[Commentsratio around 1] { \label{fig:b} 
	\includegraphics[width=0.8\columnwidth]{commentratio2.png} 
	}  
...
\begin{figure} [H]
	\centering 
	\subfigure[Russain Stackoverflow Active.] { \label{fig:a} 
	\includegraphics[width=0.7\columnwidth]{commentexample1.png} 
	} 
	\subfigure[Russain Stackoverflow Inactive.] { \label{fig:b} 
	\includegraphics[width=0.7\columnwidth]{commentexample2.png} 
	}
	\subfigure[Stackoverflow Activite.] { \label{fig:b} 
	\includegraphics[width=0.7\columnwidth]{commentexample3.png} 
	}  
	\subfigure[Stackoverflow Inactive.] { \label{fig:a} 
	\includegraphics[width=0.7\columnwidth]{commentexample4.png} 
	} 
	\caption{ 8 examples(Part 1) } 
	\label{fig} 
	\end{figure}
\begin{figure} [H]
	\centering 
	\subfigure[Total Active.] { \label{fig:b} 
	\includegraphics[width=0.7\columnwidth]{commentexample5.png} 
	}
	\subfigure[Total Inactive.] { \label{fig:b} 
	\includegraphics[width=0.7\columnwidth]{commentexample6.png} 
	}  
	\subfigure[Both Active.] { \label{fig:a} 
	\includegraphics[width=0.7\columnwidth]{commentexample7.png} 
	} 
	\subfigure[Both Inactive.] { \label{fig:b} 
	\includegraphics[width=0.7\columnwidth]{commentexample8.png} 
	}
	\label{fig} 
	\end{figure}
\section{Tags}
...
\begin{figure} [H]
	\centering 
	\subfigure[The top 30 frequent tags in Stackoverflow.] { \label{fig:b} 
	\includegraphics[width=0.7\columnwidth]{stackfre.png} 
	}
	\subfigure[The top 30 frequent tags in Russian Stackoverflow.] { \label{fig:b} 
	\includegraphics[width=0.7\columnwidth]{russianfre.png} 
	}  
	\subfigure[The top frequent russian tags that exist in both sites] { \label{fig:b} 
	\includegraphics[width=0.7\columnwidth]{overlapfre.png} 
	} 
	\label{fig} 
	\end{figure}
	...
	\begin{figure} [H]
	\centering 
	\subfigure[The top frequent russian tags only in Russian Site ] { \label{fig:b} 
	\includegraphics[width=0.7\columnwidth]{notoverlap.png} 
	}
